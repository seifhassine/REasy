...
class MotfsmGraphWorkspace(QWidget):
    ...
    def __init__(self, handler):
        ...
        self.node_details = QSplitter(Qt.Vertical, self)
        ...
        navigation.setMinimumWidth(240)
        ...
        self.graph_page.addWidget(self.node_details)
        ...
        self.node_details.addWidget(center)
        ...
        self.node_details.addWidget(inspector_page)
        self.node_details.setStretchFactor(0, 1)
        self.node_details.setStretchFactor(1, 2)
        self.node_details.setSizes([310, 640])
        self.node_details.setCollapsible(0, True)
        self.node_details.setCollapsible(1, False)
        center.setMinimumHeight(0)
        self.view.setMinimumHeight(0)
        self.graph_page.setChildrenCollapsible(False)
        self.graph_page.setStretchFactor(0, 3)
        self.graph_page.setStretchFactor(1, 7)
        self.graph_page.setSizes([440, 1040])
