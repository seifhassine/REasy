...
class GuidData:
    def __init__(self, guid_str: str, raw_bytes: bytes = None):
...
class OBBData:
    def __init__(self, values):
        ...
        if isinstance(values, (tuple, list)):
            # Convert input values to float and extend list
...
class RawBytesData:
    ...
    def __init__(self, raw_bytes: bytes, field_size: int):
...
def get_type_class(field_type: str, field_size: int = 4, is_native: bool = False, is_array: bool = False, align = 4) -> type:
    ...
    # For unknown types, return RawBytesData
