...
If you want to run REasy on Linux, make sure you use Python 3.13. If you encounter the error "Aborted" on launch, try running installing libxcb-cursor0 using apt-get. 
