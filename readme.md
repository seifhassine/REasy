...
I have currently rushed the release and the structure will be improved in the upcoming updates. Supports RSZ files (SCN, PFB, User) from all games
...
| User       | ✅       | ✅       | RE4, MHWS (Theoretically works on other games)       |
